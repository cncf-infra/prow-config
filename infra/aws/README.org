...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: verify-conformance-release
          image: 928655657136.dkr.ecr.ap-southeast-2.amazonaws.com/verify-conformance-release@sha256:ca3be9f28d2b612183ee31de95f03b4a9470fd1b68fb05c460e6e4c8470a6d9d
          imagePullPolicy: IfNotPresent
          args:
