  ...
  acme:
    ...
    - http01:
      ...
      selector:
        ...
        - www.ii-sandbox.${SHARINGIO_PAIR_BASE_DNS_NAME}
#+END_SRC
...
metadata:
  ...
  namespace: default
spec:
  commonName: ii-sandbox.${SHARINGIO_PAIR_BASE_DNS_NAME}
  dnsNames:
...
spec:
  ...
  values:
    ...
    ingress:
      enabled: true
      hosts:
      - host: www.ii-sandbox.${SHARINGIO_PAIR_BASE_DNS_NAME}
        paths:
        - /
...
#+RESULTS:
#+begin_example
helmrelease.helm.fluxcd.io/public-html created
#+end_example
