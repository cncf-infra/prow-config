...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: verify-conformance-release
          image: 928655657136.dkr.ecr.ap-southeast-2.amazonaws.com/verify-conformance-release@sha256:771074c38812106328b8514875ba656839dbef640921bd259f469b766678165a
          imagePullPolicy: IfNotPresent
          args:
